                  ...
                  <div id="applicationSettings" class="panel-collapse collapse show" aria-expanded="true">
                    <div class="box-body">
						...
						<div class="row">
							...
							<input type="email" readonly="true" maxlength="100" name="AdminEmailAddress" class="form-control" data-email="admin" id="AdminEmailAddress" value="{{session('step2.AdminEmailAddress')}}">
							</div>
							</div>
							<div class="col-sm-6 col-lg-6 col-md-6">
							<div class="form-group ">
